...
const { registerUser, loginUser, logoutUser, forgetPassword, getSingleUser, checkTokenValid, tryA, updateProfile, updatePassword, getUserDetail, getAllUser, deleteUser } = require('../controllers/userController')
...
router.route("/token/valid").post(checkTokenValid)
